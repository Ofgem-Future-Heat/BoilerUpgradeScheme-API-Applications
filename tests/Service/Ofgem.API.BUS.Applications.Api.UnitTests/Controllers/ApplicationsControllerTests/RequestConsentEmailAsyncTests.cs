...
/// </summary>
public class RequestConsentEmailAsyncTests : ApplicationsControllerTestsBase
{
    [Test]
    public async Task RequestConsentEmailAsync_ShouldReturnOkObjectResultWithServiceObject_WhenServiceReturnsASuccessResult()
    {
        ...
        _mockApplicationsService = new Moq.Mock<Core.Interfaces.IApplicationsService>(MockBehavior.Strict);
