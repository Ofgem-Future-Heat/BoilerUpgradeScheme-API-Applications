...
namespace Ofgem.API.BUS.Applications.Providers.DataAccess.Migrations
{
    ...
    [Migration("20220928100428_PropertyDetailLengths")]
    partial class PropertyDetailLengths
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.Application", b =>
                {
                    ...
                    b.Property<Guid?>("CurrentContactId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("InstallerReplyByDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ReferenceNumber")
                        .HasDatabaseName("A_Index_ReferenceNumber");
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.ApplicationDashboard", b =>
                {
                    b.Property<string>("AddressLine1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ApplicationAndVoucherStatus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ApplicationDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ApplicationSubStatus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ApplicationSubStatusCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ConsentState")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IsBeingAudited")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Postcode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RedemptionRequestDate")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("VoucherSubStatusCode")
                        .HasColumnType("nvarchar(max)");

                    b.ToView("vw_Dashboard_Applications_Only");
                });
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.ApplicationStatus", b =>
                {
                    ...
                    b.Property<string>("DisplayLegend")
                        .IsRequired()
                        .HasMaxLength(1024)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.Entities.Views.ExternalPortalDashboardApplication", b =>
                {
                    b.Property<DateTime>("ApplicationCreatedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("InstallationAddressCounty")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InstallationAddressLine1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InstallationAddressLine2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InstallationAddressLine3")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InstallationAddressPostcode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("VoucherStatusCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("VoucherStatusId")
                        .HasColumnType("uniqueidentifier");

                    b.ToView("vw_External_Dashboard_Applications");
                });
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.ExternalApplicationDashboard", b =>
                {
                    b.Property<string>("AddressLine1")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("CurrentContactId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("GrantEndDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("GrantStartDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("PropertyOwnerAddressLine1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PropertyOwnerAddressLine2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PropertyOwnerAddressLine3")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PropertyOwnerCounty")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PropertyOwnerPostcode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PropertyOwnerTelephoneNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("TechTypeExpiryIntervalMonths")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("VoucherIssuedDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("VoucherRedemptionRequestDate")
                        .HasColumnType("datetime2");

                    b.ToView("vw_External_Dashboard_Applications_Only");
                });

            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.Feedback", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("FedbackOn")
                        .HasColumnType("datetime2");

                    b.Property<string>("FeedBackNarrative")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.SurveyOption", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("FeedbackOption")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.Feedback", b =>
                {
                    ...
                    b.HasOne("Ofgem.API.BUS.Applications.Domain.SurveyOption", "SurveyOption")
                        .WithMany()
            ...
            modelBuilder.Entity("Ofgem.API.BUS.Applications.Domain.Voucher", b =>
                {
                    ...
                    b.HasOne("Ofgem.API.BUS.Applications.Domain.Grant", "Grant")
                        .WithMany()
            ...
            modelBuilder.Entity("Ofgem.Lib.BUS.AuditLogging.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("Ofgem.API.BUS.Applications.Domain.Application", null)
                        .WithMany()
